...
class ContentSituationClassificationClass():
    def __init__(self):
        ...
        self.system_prompt_tokens = 11860
        self.model_name = context.classification_model
        self.model_input_token_cost_per_million = float(context.classification_model_prompt_cost)
        self.model_output_token_cost_per_million = float(context.classification_model_completion_cost)
    ...
    async def classify(self, input_str: str):
        ...
        input_tokens = count_tokens_approximately(input_str) + self.system_prompt_tokens
