...
create basic adapter dataset from tweets, monologue

very basic analysis of tweets and quotes via node and pipeline before storing then prompt injecting in load consciousness
...
# use reference audio for diarization
# diarize songs to text

# process upload text documents that are autobiographical (needs facts extracted and re-written using LLM; facts must not change but the wording changes to prevent lawsuit: https://lexfridman.com/, https://www.hubermanlab.com/about, https://en.wikipedia.org/wiki/Lex_Fridman; extract facts and quote from wikis: https://fallout.fandom.com/wiki/Curie); https://github.com/efwoods
