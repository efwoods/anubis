...
from src.subgraphs.conversational_memory_graph.utils.state import AgentState
from src.subgraphs.conversational_memory_graph.utils.model import init_model
...
from src.subgraphs.conversational_memory_graph import utils
...
from src.anubis.utils.state import State
...
async def call_model(state: State, runtime: Runtime[Context]) -> dict:
    ...
    provider_model = runtime.context.provider_model
...
{formatted}
    ...
    llm = init_model(model, api_key, base_url)
